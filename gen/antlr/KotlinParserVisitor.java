...
public interface KotlinParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asExpressionTail}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsExpressionTail(KotlinParser.AsExpressionTailContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#callExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCallExpression(KotlinParser.CallExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#labeledExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLabeledExpression(KotlinParser.LabeledExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#dotQualifiedExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDotQualifiedExpression(KotlinParser.DotQualifiedExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#indexingExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIndexingExpression(KotlinParser.IndexingExpressionContext ctx);
	/**
